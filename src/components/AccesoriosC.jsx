...
const AccesoriosC = () => {
  ...
  const getAllProducts = async () => {
    try {
      ...
      // Filtrar productos por categoría "Alimentos"
      const alimentosProducts = data.getAllProducts.filter(product => product.categoria === 'accesorio');
      setProducts(alimentosProducts);
    } catch (error) {
